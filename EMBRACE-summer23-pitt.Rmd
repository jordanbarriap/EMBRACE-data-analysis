...
TotVoc_lm_retell_ratio = lm(formula = Post.Test_Retell_TypeToken_Ratio ~  Pre.Test_Retell_TypeToken_Ratio*totalQuestionTime + Pre.Test_Retell_TypeToken_Ratio*totalReadingTime_log, data = df_complete_retell)

TotVoc_lm_retell_mem = lm(formula = Story.Mem_Post.Test ~  Story.Mem_Pre.Test*totalQuestionTime, data = df_complete_retell)
...
cgroup <- factor(df_complete_comp$Par_Edu)
...
#Post.Test_Retell_TypeToken_Ratio ~ Pre.Test_Retell_TypeToken_Ratio +
#Retell_TypeToken_Ration_Learning_Gain
lm_comp = lm(formula = Post_Comprenhension_task ~  Pre_Comprenhension_task*totalQuestionTime+ Pre_Comprenhension_task*totalReadingTime_log, data = df_complete_comp)
...
plot(df_complete_comp$totalQuestionTime,df_complete_comp$Post_Comprenhension_task)
